\section{Policy Optimization and Algorithm}
\label{appx:policy-optimization-algorithm}
...
The reward is computed over the set of role-conditioned generations, but the trainable model remains a single shared policy. Algorithm~\ref{alg: moda short} in the main text summarizes the training procedure.
