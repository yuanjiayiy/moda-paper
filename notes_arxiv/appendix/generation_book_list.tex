...
\begin{respboxsm}{Qwen3-8B - Sample 1}
...
\end{minipage}\hfill%
\begin{minipage}[t]{0.32\linewidth}
\begin{respboxsm}{Qwen3-8B - Sample 2}
...
\end{minipage}\hfill%
\begin{minipage}[t]{0.32\linewidth}
\begin{respboxsm}{Qwen3-8B - Sample 3}
...
\begin{minipage}[t]{0.32\linewidth}
\begin{respboxsm}{Qwen3-8B - Sample 4}
...
\end{minipage}\hfill%
\begin{minipage}[t]{0.32\linewidth}
\begin{respboxsm}{Qwen3-8B - Sample 5}
...
\end{minipage}\hfill%
\begin{minipage}[t]{0.32\linewidth}
\begin{respboxsm}{Qwen3-8B - Sample 6}
...
\begin{minipage}[t]{0.32\linewidth}
\begin{modarespboxsm}{\method{}- Role 1}
...
\end{minipage}\hfill%
\begin{minipage}[t]{0.32\linewidth}
\begin{modarespboxsm}{\method{}- Role 2}
...
\end{minipage}\hfill%
\begin{minipage}[t]{0.32\linewidth}
\begin{modarespboxsm}{\method{}- Role 3}
...
\begin{minipage}[t]{0.32\linewidth}
\begin{modarespboxsm}{\method{}- Role 4}
...
\end{minipage}\hfill%
\begin{minipage}[t]{0.32\linewidth}
\begin{modarespboxsm}{\method{}- Role 5}
...
\end{minipage}\hfill%
\begin{minipage}[t]{0.32\linewidth}
\begin{modarespboxsm}{\method{}- Role 6}
