...
\input{notes_arxiv/appendix/diversity_main_error_bar}
...
\input{notes_arxiv/appendix/general_capability_error_bar}
...
\end{minipage}
\caption{\textbf{General capability retention: pass@k accuracy.} Qwen3-8B base and thinking disabled models on the general capability suite tasks: GSM8K, MMLU, GPQA, BoolQ, HellaSwag, TruthfulQA, and IFEval. The suite average is shown in Figure~\ref{fig:general capability retention} in the main text.}
...
\centering
  \centering
  \includegraphics[width=0.5\linewidth]{figures/pareto_ablation_standard_vs_diverse.png}
  \label{fig: ablation diverse standard}
  \caption{Diversity-quality trade-off under diverse and standard mode. Pass@1 accuracy.}
\end{figure}
