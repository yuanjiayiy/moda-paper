...
\end{minipage}
\caption{\textbf{General capability retention: pass@k accuracy.} Qwen3-8B base and thinking disabled models on the general capability suite tasks: GSM8K, MMLU, GPQA, TruthfulQA, BoolQ, and IFEval. The suite average is shown in Figure~\ref{fig:general capability pass@k} in the main text.}
