...
\begin{figure}[t]
\centering
\includegraphics[width=0.32\linewidth]{figures/main_pass_k/pass_at_k_figures/pass_at_k_avg_thinking_false_base_model_qwen3-8b.png}
\caption{\textbf{General capability retention: pass@k accuracy.} Qwen3-8B base, thinking disabled models on the general capability suite average. Per-benchmark results (GSM8K, MMLU, GPQA, BoolQ, TruthfulQA, IFEval) are shown in Appendix \ref{appx:general capability retention} Figure \ref{fig:general capability pass@k thinking disabled}.}
