...
\begin{figure}[ht]
\centering
\includegraphics[width=0.45\linewidth]{figures/pareto_infinite-chat_quality_thinking_false_base_model_qwen3-8b_composite.png}
\hfill
\includegraphics[width=0.45\linewidth]{figures/pareto_infinite-chat_quality_ablations_composite.png}
